...
class Ruleta:
    ...
    def grafico_flujo_caja_promedio(self, listados_capital):
        ...
        ax.set_title(f'Evolucion del capital promedio de las {cantidad_corridas} corridas - Estrategia: {estrategias_apuesta[tipo_estrategia]} - Tipo de capital: {capital[tipo_capital]}')
...
# Si la persona envía -k y -p, los capturamos
if len(sys.argv) >= 15:
    capital_inicial = int(sys.argv[12])
    apuesta_inicial = int(sys.argv[14])
